...
HQ=$($PSQL -At -c "insert into user_roles(user_id,role) values (gen_random_uuid(),'hq_operator') returning user_id")
...
S=$($PSQL -At -c "insert into inv_skus default values returning id")
