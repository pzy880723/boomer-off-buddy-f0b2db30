...
for f in drizzle/migrations/0003_*.sql drizzle/migrations/0004_*.sql drizzle/migrations/0005_*.sql tests/sql/harness/payment_events.sql drizzle/migrations/0007_*.sql drizzle/migrations/0008_*.sql /tmp/origin_pre.sql; do
