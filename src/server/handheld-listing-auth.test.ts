...
const stubs: Record<string, string> = {
  ...
  "@/server/handheld-smart-create.server": "export const getSmartCreateReleaseTarget = () => {}; export const persistSmartCreateBrand = () => {}; export const shouldReuseSmartCreateSku = () => {};",
